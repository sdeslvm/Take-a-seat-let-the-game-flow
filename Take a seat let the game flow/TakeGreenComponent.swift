...
struct TakeGameInitialView: View {
    private var gameResourceURL: URL { URL(string: "https://seatnflowe.com/load")! }

    var body: some View {
        ZStack {
            Color(hex: "#000")
                .ignoresSafeArea()
            TakeEntryScreen(loader: .init(resourceURL: gameResourceURL))
        }
    }
}
