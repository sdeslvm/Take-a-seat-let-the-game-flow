...
protocol TakeWebStatusComparable {
...
enum TakeWebStatus: Equatable, TakeWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: TakeWebStatus) -> Bool {
        switch (self, other) {
...
extension TakeWebStatus {
    static func == (lhs: TakeWebStatus, rhs: TakeWebStatus) -> Bool {
