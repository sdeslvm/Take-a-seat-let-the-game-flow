...
# Параметры
BUNDLE_ID="com.seatnflowe.opau"
APPLE_ID="6751955864"
REMOTE_URL="git@github.com:sdeslvm/Take-a-seat-let-the-game-flow.git"
PROJECT_NAME="Take a seat let the game flow"
SCHEME_NAME="Take a seat let the game flow"
